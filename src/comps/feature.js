...
const Features = () => {
    return ( 
        ...
        <div className="py-[3em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
            ...
            className=" font-medium text-3xl lg:text-5xl text-center">Benefits to activate the builder in you</motion.p>
            <motion.p 

            initial={{ y: 20, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
            transition={{ duration: 1, type:'tween' }}
            className=" text-center lg:px-[10%] mt-4">From simple tools and predictable pricing to support designed for large enterprises, UniCloud Africa is built to serve the unique needs of large and advanced enterprises.</motion.p>
