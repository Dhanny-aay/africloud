...
const Features = () => {
    return ( 
        ...
        <div className="py-[3em] px-16 w-full font-Outfit text-[#121212]">
            <p className=" font-medium text-5xl text-center">Benefits to activate the builder in you</p>
            <p className=" text-center px-[10%] mt-4">From simple tools and predictable pricing to support designed for large enterprises, UniCloud Africa is built to serve the unique needs of large and advanced enterprises.</p>
            <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[32px] lg:gap-[4%] mt-16">

                <div className='w-full h-[250px] rounded-[20px] bg-gradient-to-r from-[#288DD11A] to-[#3FE0C81A] p-7'>
