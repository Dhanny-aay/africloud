    ...
    return ( 
        ...
        <div className=" py-[3em] px-4 md:px-16 w-full font-Outfit text-[#121212]">
            ...
            <div className=" py-12 flex justify-between w-full">
                ...
                <div className=" w-1/2 h-[500px] bg-[#288DD11A] rounded-[30px] hidden md:flex justify-center items-center">
                    <img src={ blag } alt="" />
                </div>
            </div>
        </div>
