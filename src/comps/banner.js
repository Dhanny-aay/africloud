...
const Banner = () => {
    return ( 
        ...
        className=" mt-[6em] md:mt-0 py-[3em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#fff]">
            <div className=" w-full h-[600px] md:h-[400px] rounded-[30px] bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] relative p-6 lg:p-12 z-10"> 
                ...
                <img src={ archi } className=' -z-[1] opacity-80 md:opacity-100 absolute right-0 bottom-0 rounded-br-[30px]' alt="" />
            </div>
        </motion.div>
        </>
     );
